...
if not defined? Authorization::Base::LOGIN_REQUIRED_REDIRECTION
  Authorization::Base::LOGIN_REQUIRED_REDIRECTION = {:controller => '/user_sessions', :action => 'new'}  
end

if not defined? Authorization::Base::PERMISSION_DENIED_REDIRECTION
  Authorization::Base::PERMISSION_DENIED_REDIRECTION = {:controller => 'works', :action => 'index'}
end

if not defined? Authorization::Base::STORE_LOCATION_METHOD 
